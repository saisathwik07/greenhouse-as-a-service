...
app.use(
  cors({
    origin: ["https://gaas-drab.vercel.app", "http://localhost:5173", "https://gaas-git-main-saisathwik123456-9451s-projects.vercel.app", "https://greengaas.vercel.app"],
    credentials: true,
...
/** Public guest feature registry — GET /api/guest-access (see routes/guestAccess.js) */
app.use("/api", guestAccessRoutes);
